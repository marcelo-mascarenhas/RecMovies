...
class TestCrawler():
    ...
    def test_if_strings_are_being_formated_correctly(self):
    ...
    def test_if_empty_dictionary_raises_exception(self):
        crawler_object = Crawler()
        movies_dictionary = {}
    ...
    def test_if_content_is_being_created_correctly(self):
        crawler_object = Crawler()
    ...
    def test_if_release_date_is_treated_correctly(self):
        crawler_object = Crawler()
        movie = {'title': 'Wonderland', 'original_language': 'en', 'genres': [{'name': 'Fantasy'}], "overview": 
        "Wonderland is a movie that shows the adventures of a girl in a fantasy world", "popularity": 100.0,
